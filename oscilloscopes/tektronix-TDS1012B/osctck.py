...
class Osctck(object):
    ...
    def __call__(self):
        ...
        self._osci.write("CH"+str(self._channels[0])+":BANDWIDTH " + self._chanband)
        self._osci.write("CH"+str(self._channels[0])+":INV " + self._chaninv) 
        ...
        if self._vAutoScale == True:
            ...
            for ii in range(asiter):
                ...
                maxValue = np.max(np.absolute(self.getVertValues(self._channels[0])))
                vScale = maxValue/3.5
